package net.yxchen.orthodontichelper.circleprogress;
...
import net.yxchen.orthodontichelper.circleprogress.utils.Constant;
import net.yxchen.orthodontichelper.circleprogress.utils.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private float mTextValue;// 自己加的。mValue 小于等于 mMaxValue，但是 mTextValue 不会。
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(String.format(mPrecisionFormat, mTextValue), mCenterPoint.x, mValueOffset, mValuePaint);
